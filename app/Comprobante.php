...
class Comprobante extends Model
{
	...
	protected $fillable = ['fecha_emision', 'numeracion', 'sum_otros_cargos', 'importe_total', 'tipo_moneda', 'version_ubl', 'version_doc', 'descuentos_glob', 'percepmonenac_importe_id', 'cliente_id', 'information_id', 'remision_guia_id', 'otros_documento_id', 'comprobante_tipo_id'];
