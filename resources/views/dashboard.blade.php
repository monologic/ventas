...
<html lang="en">
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('assets/iCheck/skins/flat/green.css')}}" />
    <!-- bootstrap-progressbar -->
    <link rel="stylesheet" href="{{asset('assets/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')}}" />
    <!-- JQVMap -->
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Productos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#/Productos/nuevo">Crear</a></li>
                    </ul>
                  </li>
